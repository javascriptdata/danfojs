            ...
            if (typeof file === "string" && file.startsWith("http")) {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        reader.onload = function (event) {
                            ...
                            resolve(new index_1.DataFrame(jsonObj));
                        };
                    })];
            }
            else {
...
var $toJSON = function (df, options) {
    var _a = __assign({ fileName: "output.json", download: true, format: "column" }, options), fileName = _a.fileName, format = _a.format, download = _a.download;
    if (df.$isSeries) {
        var obj = {};
