    ...
    **/
    ...
    DataFrame.prototype.$getTensorsForArithmeticOperationByAxis = function (other, axis) {
        if (typeof other === "number") {
            return [this.tensor, (0, tfjs_1.scalar)(other)];
        }
            ...
            if (axis === 0) {
                return [this.tensor, (0, tfjs_1.tensor2d)(other.values, [other.shape[0], 1])];
            }
            else {
                return [this.tensor, (0, tfjs_1.tensor2d)(other.values, [other.shape[0], 1]).transpose()];
            }
        }
        else if (Array.isArray(other)) {
            if (axis === 0) {
                return [this.tensor, (0, tfjs_1.tensor2d)(other, [other.length, 1])];
            }
            else {
                return [this.tensor, (0, tfjs_1.tensor2d)(other, [other.length, 1]).transpose()];
            }
        }
        else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, tfjs_1.data.array(this.index).shuffle(num, "" + seed).take(num).toArray()];
                    case 1:
