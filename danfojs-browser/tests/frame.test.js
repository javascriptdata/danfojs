...
describe("DataFrame", function () {
  ...
  //             const cols = ["A", "B", "C"];
  //             const df = new dfd.DataFrame(data, { columnNames: cols });
  ...
  //             const expected_df = new dfd.DataFrame(expected_data, { columnNames: expected_cols });
  ...
  //             const cols = ["A", "B", "C"];
  //             const df = new dfd.DataFrame(data, { columnNames: cols, index: ["a", "b", "c"] });
  ...
  //             const cols = ["A", "B", "C"];
  //             const df = new dfd.DataFrame(data, { columnNames: cols, index: ["a", "b", "c", "a", "b"] });
  ...
  describe("loc", function () {
    ...
    it(`check data after selecting { "rows": ["0", "1"], "columns": ["B", "C"] }`, function () {
      const data = [ [ 1, 2, 3 ], [ 4, 5, 6 ] ];
      const cols = [ "A", "B", "C" ];
      const df = new dfd.DataFrame(data, { columnNames: cols, index: [ "0", "1" ] });
    ...
    it("check data after row and column slice", function () {
      const data = [ [ 1, 2, 3 ], [ 4, 5, 6 ], [ 20, 30, 40 ], [ 39, 89, 78 ] ];
      const cols = [ "A", "B", "C" ];
      const df = new dfd.DataFrame(data, { columnNames: cols, index: [ "0", "1", "2", "3" ] });
  ...
  describe("mean", function () {
    it("Returns the mean of a DataFrame (Default axis is [1:column])", function () {
      const data = [ [ 0, 2, 4 ],
        [ 360, 180, 360 ] ];
      const df = new dfd.DataFrame(data, { columnNames: [ "col1", "col2", "col3" ] });
  ...
  //             const cols = ["A", "B", "C"];
  //             const df = new dfd.DataFrame(data, { columnNames: cols });
  //             const sf = new dfd.Series(["n", "b", "c", "f"]);
  ...
  //     //         const cols1 = ["A", "B", "C"]
  //     //         const df1 = new dfd.DataFrame(data1, { columnNames: cols1 })

  //     //         const data2 = [[1, 2, 3, 5], [4, 5, 6, 8], [20, 30, 40, 10]]
  //     //         const cols2 = ["A", "B", "C", "D"]
  //     //         const df2 = new dfd.DataFrame(data2, { columnNames: cols2 })
  ...
  describe("dropNa", function () {
    it("drop NaNs along axis 1", function () {
      const data = [ [ 0, 2, 4 ],
        ...
        [ NaN, 180, 360 ] ];
      const column = [ "A", "B", "C" ];
      const df = new dfd.DataFrame(data, { columnNames: column });
      const df_val = [ [ 2, 4 ],
        [ 180, 360 ],
        [ 180, 360 ] ];
  ...
  //             ["B", "A", 2, "woman"],
  //             ["A", "B", 3, "man"]];
  //             const df = new dfd.DataFrame(data1, { columnNames: ["col1", "col2", "col3", "col4"] });
  ...
  //             const cols = ["a", "b", "c", "d"];
  //             const df = new dfd.DataFrame(data1, { columnNames: cols });
  //             const df_trans = df.T;
