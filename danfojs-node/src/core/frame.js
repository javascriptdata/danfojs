...
//     const { index, columns, dtypes, config } = { index:[], columns:[], dtypes:[], config:{}, ...options };
...
//     const columnValues = this.$getColumnData(column, false);
//     const index = [...this.index];
