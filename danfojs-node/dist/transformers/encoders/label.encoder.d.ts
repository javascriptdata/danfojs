...
export default class LabelEncoder {
    ...
    */
     ...
     * ```
    */
    transform(data: Array<string | number> | Tensor | Series): Series | number[] | import("@tensorflow/tfjs-node").Tensor1D;
    /**
     ...
     * ```
     */
    fitTransform(data: Array<string | number> | Tensor | Series): Series | number[] | import("@tensorflow/tfjs-node").Tensor1D;
    /**
     ...
     * ```
    */
    inverseTransform(data: Array<number> | Tensor | Series): Series | import("@tensorflow/tfjs-node").Tensor1D | (string | number | undefined)[];
    /**
